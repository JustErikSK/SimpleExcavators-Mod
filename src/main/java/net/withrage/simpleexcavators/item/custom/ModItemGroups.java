...
public class ModItemGroups {
    ...
    public static final ItemGroup SIMPLE_EXCAVATORS = Registry.register(
            Registries.ITEM_GROUP,
            Identifier.of(SimpleExcavators.MOD_ID, "simpleexcavators"),
            FabricItemGroup.builder()
                    .displayName(Text.translatable("itemgroup.simpleexcavators"))
                    ...
                    .entries((context, entries) -> {
                        ...
                        entries.add(ModItems.GOLDEN_EXCAVATOR_HEAD);
                        entries.add(ModItems.IRON_EXCAVATOR_HEAD);
                        entries.add(ModItems.EMERALD_EXCAVATOR_HEAD);
                        entries.add(ModItems.DIAMOND_EXCAVATOR_HEAD);
                    })
                    .build()
    );
